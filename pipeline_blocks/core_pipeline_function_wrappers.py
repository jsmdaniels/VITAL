...
def generate_features(base_path, event_type, reduced_patient_matrix, window_size_samples, filter_params, signal_wavelength, fe_method, fe_segment_length_samples, window_divider, num_stft_windows, stft_resolution, training_data_pickle_path, segmented_labels, label_name):
